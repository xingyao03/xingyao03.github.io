...
summary: "A simple 2-D diagram highlighting important posts based on selected criteria."
---
...
# **Visualization**
## Filter By Comments
<img width="100%" class="rounded float-start pe-4" src="../img/SocialMediaVisual1.png">

<br>

## Filter By Views
<img width="100%" class="rounded float-start pe-4" src="../img/SocialMediaVisual2.png">

<br>

## Filter By Blend Score 
**Blend Score = 0.7 × Comments + 0.3 × Views**
<img width="100%" class="rounded float-start pe-4" src="../img/SocialMediaVisual3.png">
